...
///点击右边按钮的会调
@property (nonatomic,copy) backForUpperLevelWithVoid callbackForRightItem;
- (void)setCallbackForRightItem:(backForUpperLevelWithVoid)callbackForRightItem;

///调用扩展的logOnDealloc方法绑定对象，实现对象销毁日志自动打印
- (void)GSInitViewController;
