...
-(NSArray *)childControllerNames
{
    ...
    {
        _childControllerNames = @[@"HomeSectionViewController",
...
-(NSArray *)normalImageNames
{
    ...
    {
        _normalImageNames = @[@"OneSection1",@"TowSection1"];
    }
...
-(NSArray *)selectImageNames
{
    ...
    {
        _selectImageNames = @[@"OneSection2",@"TowSection2"];
    }
...
- (void)viewDidLoad {
    ...
    //选中时的颜色
    self.tabBar.tintColor = Color35_128_215;
}
//利用反射的方式创建子控制器对象（亮点）
