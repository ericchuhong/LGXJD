...
//        self.backgroundColor = [UIColor whiteColor];
        ...
        _CCLabelForLeft = [UILabel initForLabelWithFatherView:self Size:15
                                                        Color:RGB(53.0, 53.0, 53.0, 1.0) Tital:@"收入"];
        ...
        _CCLabelForRight = [UILabel initForLabelWithFatherView:self Size:15
                                                         Color:RGB(53.0, 53.0, 53.0, 1.0) Tital:@"支出"];
